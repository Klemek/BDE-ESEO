...
public class TreeView extends View {
    ...
    private Paint pb, pb2, pb2g, pline, pbx, pn2, pn, ppr;
    ...
    private void organize(){
        ...
        while(cont){
            ...
            for(int k: f2.keySet()){
                ...
                if(names[si.getRank()-rnkmx+depth] == null){
                    names[si.getRank()-rnkmx+depth]  = si.getPromo();
                }
    ...
    public void onDraw (Canvas canvas){
        ...
        if(family != null && family.size() > 0){
            ...
            for(int k = 0; k  < depth; k++){
                ...
                canvas.drawText(names[depth-k], k * dx * 3 / 2 + dx, bs, ppr);
